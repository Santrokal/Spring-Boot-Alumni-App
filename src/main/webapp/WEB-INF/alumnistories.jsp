...
<!-- Alumni Stories Section with Animated Design -->
    ...
    %>
        <div class="row">
            <% for (int i = 0; i < storiesList.size(); i++) { 
                StoryEntity stories = storiesList.get(i); 
            %>
                <div class="col-lg-3 col-md-6 col-sm-12 mb-4 d-flex align-items-stretch">
                    <div class="card-container">
                        <img class="card-img" src="data:image/jpeg;base64,<%= stories.getImageBase64() %>" alt="Story Image">
                        <div class="card-content">
                            <h5 class="card-title"><%= stories.getTitle() %></h5>
                            <p class="card-description"><%= stories.getContent() %></p>
                            <p class="card-date">Published on: <%= stories.getCreatedAt() %></p>
                            <a href="/stories/<%= stories.getId() %>" style="text-decoration: none; color: inherit;">Expand</a>
                        </div>
                    </div>
                </div>
                <% 
                    // Close and open a new row after every 4 stories
    ...
    color: #888;
       ...
       <!-- Add Story Button -->
        <div class="d-flex justify-content-end w-100 mb-3" style="max-width: 800px;">
            <a href="/addstories" class="btn btn-success">Add Story</a>
        </div>
