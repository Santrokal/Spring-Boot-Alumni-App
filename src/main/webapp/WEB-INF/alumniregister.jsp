...
<body>
    <div class="container">
        <div class="form-container floating">
            ...
            <form id="alumniForm" action="/register" method="post"
                enctype="multipart/form-data" class="mt-4">
               <div class="mb-3">
					<label class="form-label">Full Name:<span style="color: red;">*</span></label> <input type="text"
						name="fullname" class="form-control" required>
				</div>
				<div class="mb-3">
					<label class="form-label">Father's Name: <span style="color: red;">*</span></label> <input type="text"
						name="fathersname" class="form-control" required>
				</div>
				<div class="mb-3">
					<label class="form-label">Nationality:<span style="color: red;">*</span></label> <input type="text"
						name="nationality" class="form-control" required>
				</div>
				<div class="mb-3">
					<label class="form-label">Date of Birth:<span style="color: red;">*</span></label> <input type="date"
...
<div class="mb-3">
    ...
    <input type="number" name="shc_stay_to" 
		...
		<div class="mb-3">
			<label class="form-label">Mobile No:<span style="color: red;">*</span></label> <input type="text"
				name="phoneno" class="form-control" required>
		</div>
		<div class="mb-3">
			<label class="form-label">Email Address:<span style="color: red;">*</span></label> <input type="email"
				name="emailaddress" class="form-control" required>
		</div>
		<!-- Full Address -->
		<div class="mb-3">
			<label class="form-label">Full Address:<span style="color: red;">*</span></label> <input type="text"
				name="house_flat_number" placeholder="House/Flat Number"
				class="form-control mb-2" required> <input type="text"
				name="street_name" placeholder="Street Name"
				class="form-control mb-2" required> <input type="text"
				name="city" placeholder="City" class="form-control mb-2" required>
			<input type="text" name="state" placeholder="State"
				class="form-control mb-2" required> <input type="text"
				name="postal_code" placeholder="Postal Code"
				class="form-control mb-2" required> <input type="text"
				name="landmark" placeholder="Landmark" class="form-control mb-2">
			<input type="text" name="area" placeholder="Area"
				class="form-control mb-2"> <label class="form-label">Address
				Type:</label><br> <input type="checkbox" name="address_type"
				value="Permanent" class="form-check-input"> Permanent <input
				type="checkbox" name="address_type" value="Current"
				class="form-check-input"> Current
		</div>
		<div class="mb-3">
		...
		<div class="mb-3">
			<label class="form-label">Employer/Enterprise:<span style="color: red;">*</span></label><br> <input
				type="radio" name="empstatus" value="Employer"
				class="form-check-input"> Employer <input type="radio"
				name="empstatus" value="Enterprise" class="form-check-input">
			Enterprise
		</div>
		<div class="mb-3">
			<label class="form-label">Job Designation:<span style="color: red;">*</span></label> <input type="text"
				name="jobdesig" class="form-control">
		</div>
		<div class="mb-3">
			<label class="form-label">Office Phone No:<span style="color: red;">*</span></label> <input type="text"
				name="officephoneno" class="form-control">
		</div>
		<div class="mb-3">
			<label class="form-label">Official Email:<span style="color: red;">*</span></label> <input type="email"
				name="officeemail" class="form-control">
		</div>
		<div class="mb-3">
			<label class="form-label">Field of Expertise:<span style="color: red;">*</span></label> <input
				type="text" name="fieldofexpert" class="form-control">
		</div>
