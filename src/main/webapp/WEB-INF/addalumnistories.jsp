...
<!-- Add Story Section -->
<h1 class="text-center my-4" style="color: #333;">Add Story</h1>
<div class="container">
<form id="storiesForm" onsubmit="submitForm(event)">
    <div class="form-group">
        <label for="title">Title: <span style="color: red;">*</span></label>
        <input type="text" id="title" name="title" class="form-control" required aria-label="Story Title">
    </div>
    <div class="form-group">
        <label for="content">Content: <span style="color: red;">*</span></label>
        <textarea id="content" name="content" class="form-control" rows="5" required aria-label="Story Content"></textarea>
    </div>
    <div class="form-group">
        <label for="image">Upload Image: <span style="color: red;">*</span></label>
        <input type="file" id="image" name="image" class="form-control" accept="image/*" required aria-label="Story Image">
    </div>
...
<script>
    async function submitForm(event) {
        ...
        try {
            const response = await fetch('/addstories', {
                method: 'POST',
                body: formData
            });
