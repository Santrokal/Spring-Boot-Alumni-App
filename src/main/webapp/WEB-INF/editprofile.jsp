...
<form action="/updateprofile" method="POST" enctype="multipart/form-data">
 ...
 <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="degree_obtained" value="${alumni.degree_obtained}" class="form-control"></td>
            </tr>
            <tr>
                <th>Department</th>
            ...
            <tr>
                <th>SHC Stay From</th>
                <td><input type="date" name="shc_stay_from" value="${alumni.shcStayFrom}" class="form-control"></td>
            </tr>
            <tr>
                <th>SHC Stay To</th>
                <td><input type="date" name="shc_stay_to" value="${alumni.shcStayTo}" class="form-control"></td>
            </tr>
            <tr>
