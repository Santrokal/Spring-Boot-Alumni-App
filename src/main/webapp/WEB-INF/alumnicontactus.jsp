...
<title>Alumni Story Feed Page</title>
            ...
            <div class="card border-0 shadow-lg h-100">
                <div class="card-body p-4">
                    ...
                    <p class="font-montserrat-light font17 mb-4">
                        Riga 3839, Vilku Pagasts, Latvia 57766 <br>
                        <span class="text-muted">Office Hours:</span> Monday to Friday, 10am - 7pm
                    </p>
                    <a href="/contactus" class="btn btn-outline-primary btn-sm text-uppercase hover-btn">Get Directions</a>
                </div>
            </div>
        </div>
        <!-- Get In Touch Column -->
            ...
            <div class="card border-0 shadow-lg h-100">
                <div class="card-body p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <a href="tel:+12345678900" class="font-montserrat-light font17 text-dark hover-link">+1 9009 23456789</a>
                    </div>
                    <div class="mb-3">
                        <span class="d-block font-montserrat-light font17 text-uppercase text-muted">Email:</span>
                        <a href="mailto:iff.salman366@gmail.com" class="font-montserrat-light font17 text-dark hover-link">iff.salman366@gmail.com</a>
                    </div>
                    <div>
                        <span class="d-block font-montserrat-light font17 text-uppercase text-muted">Website:</span>
                        <a href="http://localhost:8080/home" class="font-montserrat-light font17 text-dark hover-link">www.shctpt/alumni.com</a>
                    </div>
                </div>
            </div>
        </div>
