...
public class AdminController {
    ...
    public String showAdminProfilePage(HttpSession session, Model model) {
        ...
        if (loggedInAdmin != null) {
            ...
            return "redirect:/alumni"; // Redirect if no admin is logged in
        }
    }
    ...
    public String showManageUsersPage() {
        return "manageusers"; // Points to manageusers.jsp
    }
    ...
    public String showWidgetPage(HttpSession session, 
        ...
        if (loggedInAdmin == null) {
            return "redirect:/alumni"; // Ensure it redirects to the correct login page
    ...
    public String logout(HttpSession session) {
        ...
        return "redirect:/alumni"; // Redirect to login page
    }
